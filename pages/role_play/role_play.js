...
const PLAN_OPTIONS = [
  '丰富幼儿相关经验（如参观超市、医院等，观看相关角色扮演视频）',
  '调整环境、材料（如增加低结构材料、更新场景设置）',
...
Page({
  data: {
    ...
    interveneSelected: [false, false, false, false, false, false],
    strategyOptions: STRATEGY_OPTIONS,
    strategySelected: [false, false, false, false, false],
  ...
  loadObsItemsByLevel(levelIndex) {
    const obsItems = getObsItems('role_play', levelIndex);
  ...
  async loadData(id) {
    try {
      ...
      this.setData({
        ...
        obsItems,
        interveneSelected: obsData.interveneSelected || [false, false, false, false, false, false],
        strategySelected: obsData.strategySelected || [false, false, false, false, false],
